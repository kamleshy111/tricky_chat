		   ...
		   <aside class="sidebar">
			  ...
			  <nav class="sidebar-nav">
				 <ul class="metismenu" id="menu">
				    ...
				    <li>
					   <a href="#" aria-expanded="false"><i class="mdi-social-group"></i>&nbsp;<span class="menu-title">{{ _lang('Operator Management') }}</span> <span class="glyphicon arrow"></span></a>
					   <ul aria-expanded="false" class="collapse">
						  <li><a href="{{ url('users') }}">{{ _lang('All Operator') }}</a></li>
					...
					<li>
					   <a href="{{ url('meetings') }}" aria-expanded="false"><i class="mdi-hardware-phonelink"></i>&nbsp;<span class="menu-title">{{ _lang('Meetings') }}</span></a>
					</li>
					
					<li>
					   <a href="#" aria-expanded="false"><i class="mdi-action-add-shopping-cart"></i>&nbsp;<span class="menu-title">{{ _lang('Welcome Messages') }}</span> <span class="glyphicon arrow"></span></a>
					   <ul aria-expanded="false" class="collapse">
						  <li><a href="{{ url('canned_messages/create') }}">{{ _lang('Add New') }}</a></li>
						  <li><a href="{{ url('canned_messages') }}">{{ _lang('Welcome Messages') }}</a></li>
					   </ul>
					</li>
		   ...
		   <!--Start Content -->
			 <section class="content"> 
				...
				<div class="col-md-12" id="content-area"> 	 				
					@yield('content')
					<audio id="chatRequestSound">
					  <source src="{{ asset('public/sounds/chat_request.mp3') }}" type="audio/mpeg">
					</audio>
				</div>
			 </section>
		   <!-- End Content -->
