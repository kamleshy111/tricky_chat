...
Route::get('wow-meetings', 'MeetingController@index');
...
Route::group(['middleware' => ['install']], function () {	
	...
	Route::group(['middleware' => ['auth']], function () {
		...
		Route::get('meetings', 'DashboardController@meeting');
		...
		Route::get('wow-meetings', 'UtilityController@toggle_offline_mode')->name('utility.toggle_offline_mode');
